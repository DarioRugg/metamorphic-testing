...
def main(cfg : DictConfig) -> None:
    ...
    for task_type in cfg.tasks:
        if task_type != "standard":
            ...
            ae_test_results["result"], ae_test_results["distance from threshold"] = features_addition.MetamorphicTest(test_task_cfg.test).test(ae_test_results["score test"], ae_test_results["score standard"], model_arch="ae")
            ...
            clf_test_results["result"], clf_test_results["distance from threshold"] = features_addition.MetamorphicTest(test_task_cfg.test).test(clf_test_results["score test"], clf_test_results["score standard"], model_arch="clf")
